...
//   console.log(
//     `Total ${book.baseCurrency} liquidity: \t${book.bidsTotal.toFixed(3)}\tasks: ${book.asksTotal.toFixed(3)}`,
//   )
//   let orders: CumulativePriceLevel[] = book.ordersForValue("buy", 100, false)
//   console.log(
//     `Cost of buying 100 ${book.baseCurrency}: ${orders[orders.length - 1].cumValue.toFixed(2)} ${book.quoteCurrency}`,
//   )
//   orders = book.ordersForValue("sell", 1000, true)
//   console.log(
//     `Need to sell ${orders[orders.length - 1].cumSize.toFixed(3)} ${book.baseCurrency} to get 1000 ${
//       book.quoteCurrency
//     }`,
//   )
// }
